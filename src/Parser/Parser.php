...
use Felix\TwitterStream\Exceptions\ParsingException;
...
class Parser
{
    ...
    protected const STATE_END_DOCUMENT      = 14;
    protected const STATE_DONE              = -1;
    protected const STATE_IN_ARRAY          = 1;
    protected const STATE_IN_OBJECT         = 2;
    protected const STATE_END_KEY           = 3;
    protected const STATE_AFTER_KEY         = 4;
    protected const STATE_IN_STRING         = 5;
    protected const STATE_START_ESCAPE      = 6;
    protected const STATE_UNICODE           = 7;
    protected const STATE_IN_NUMBER         = 8;
    protected const STATE_IN_TRUE           = 9;
    protected const STATE_IN_FALSE          = 10;
    protected const STATE_IN_NULL           = 11;
    protected const STATE_AFTER_VALUE       = 12;
    protected const STATE_UNICODE_SURROGATE = 13;

    protected const STACK_OBJECT = 0;
    protected const STACK_ARRAY  = 1;
    protected const STACK_KEY    = 2;
    protected const STACK_STRING = 3;

    protected const UTF8_BOM  = 1;
    protected const UTF16_BOM = 2;
    protected const UTF32_BOM = 3;

    /** @var resource */
    protected $stream;
    protected ListenerInterface $listener;
    protected bool $emitWhitespace;
    protected string $buffer = '';
    protected int $bufferSize;
    /** @var string[] */
    protected array $unicodeBuffer        = [];
    protected int $unicodeHighSurrogate   = -1;
    protected string $unicodeEscapeBuffer = '';
    ...
    private function endSpecialValue(mixed $value, string $stringValue): void
    {
    ...
    public function stopParsing(): ?bool
    {
        ...
        return extension_loaded('zlib') ? gzclose($this->stream) : fclose($this->stream);
    }
}
